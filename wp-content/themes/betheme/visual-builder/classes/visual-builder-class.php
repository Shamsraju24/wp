  ...
  public function mfn_add_admin_bepopup_class($classes){
	...
	public function loadElementsObjects($p){
		...
		foreach( $elements as $e=>$element ){
			...
			if( $this->template_type && $this->template_type == 'header' && $element['cat'] != 'header' && !in_array($e, array('column', 'button', 'heading', 'payment_methods', 'image', 'plain_text', 'header_language_switcher')) ) continue;
